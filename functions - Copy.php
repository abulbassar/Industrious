...
function industrious_scripts() {
	...
	wp_enqueue_style( 'industrious-style', get_template_directory_uri().'/assets/css/main.css' );
	...
	//for js script
	wp_enqueue_script( 'jquery.min.js', get_template_directory_uri() . '/assets/scripts/jquery.min.js', array('jquery'), '3.0', true );
	wp_enqueue_script( 'jquery.min.js', get_template_directory_uri() . '/assets/js/browser.min.js', array(), '3.0', true );
	wp_enqueue_script( 'jquery.min.js', get_template_directory_uri() . '/assets/js/breakpoints.min.js', array(), '3.0', true );
	wp_enqueue_script( 'jquery.min.js', get_template_directory_uri() . '/assets/js/util.js', array(), '3.0', true );
	wp_enqueue_script( 'jquery.min.js', get_template_directory_uri() . '/assets/js/main.js', array(), '3.0', true );
